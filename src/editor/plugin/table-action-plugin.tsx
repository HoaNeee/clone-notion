    ...
    (shouldInsertAfter: boolean) => {
      editor.update(() => {
        for (let i = 0; i < selectionCounts.rows; i++) {
          const node = $insertTableRowAtSelection(shouldInsertAfter);
          if (i === 0 && node) {
            node.selectStart();
          }
        }
    ...
    (shouldInsertAfter: boolean) => {
      editor.update(() => {
        for (let i = 0; i < selectionCounts.columns; i++) {
          const node = $insertTableColumnAtSelection(shouldInsertAfter);
          if (i === 0 && node) {
            node.selectStart();
          }
        }
...
function TableCellActionMenuContainer({
  ...
  return (
    <>
      ...
      <div
        className="table-cell-action-button-container z-9999"
        ref={menuButtonRef}
      >
        {tableCellNode != null && (
          <>
            ...
            >
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="table-cell-action-button bg-gray-200"
                  ref={menuRootRef}
                >
                  <ChevronDown
                    size={16}
              ...
              <DropdownMenuContent
                side="bottom"
                align="end"
                className="z-9999 w-56 bg-white"
              >
                <TableActionMenu
