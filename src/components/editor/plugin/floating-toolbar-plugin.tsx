...
const FloatingToolbarPlugin = () => {
	...
	const $updateFloatingToolbar = useCallback(() => {
		...
		if ($isRangeSelection(selection)) {
			...
			if (content) {
				...
				if (floatingToolbarRef.current && rootElement) {
	...
	return (
		<div
			className="absolute top-0 left-0 opacity-0 z-20 transition-opacity cursor-none pointer-events-none bg-amber-500"
