...
const SidebarNavMain = () => {
	...
	return (
		<SidebarGroup className="list-container min-h-100" ref={sidebarRef}>
			<SidebarGroupLabel className="text-sm" asChild>
				<div className="flex group/item items-center justify-between relative hover:bg-neutral-100 cursor-pointer">
					<DraggingContainer
